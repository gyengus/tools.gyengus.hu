// Cikk: http://www.smashingmagazine.com/2014/06/11/building-with-gulp/
...
gulp.task( 'copy-static', [ 'web-lint' ], function( ) {
	return gulp.src( ['./web/**/*', '!web/views/*', '!web/views', '!web/css/*.styl', '!web/js/*.js'] )
...
gulp.task(jsGulp, function( callback ) {
